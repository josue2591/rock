...
lando emulsify init rock --platform drupal
echo "Installing theme dependencies..."
lando npm --prefix ./web/themes/custom/rock install --silent
lando drush site:install --existing-config --account-name=rock --account-name=superuser_1 -y
